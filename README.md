...
Great Hermes — проект рабочего ИИ-помощника, который сохраняет контекст между компьютером, мессенджером и телефоном и помогает доводить задачи до результата.
